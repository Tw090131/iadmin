      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @endif
            <br />
            <form class="form-horizontal form-label-left" id="menuForm" action="{{url('admin/menus')}}" method="post">
              {{csrf_field()}}
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" name="slug" value="{{old('slug')}}" placeholder="菜单所属权限">
                </div>
              </div>
              <div class="form-group">
