      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @endif
            <form action="{{url('admin/roles/'.$role['id'])}}" method="post" class="form-horizontal form-label-left">
              {{csrf_field()}}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="name" class="form-control col-md-7 col-xs-12" placeholder="英文名称" value="{{$role['name']}}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="last-name" name="display_name" class="form-control col-md-7 col-xs-12" placeholder="中文名称" value="{{$role['display_name']}}">
                </div>
              </div>
              <div class="form-group">
                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">描述</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="description"cols="30" rows="10" class="form-control col-md-7 col-xs-12">{{$role['description']}}</textarea>
                </div>
              </div>
              <div class="form-group">
